...
public class Blackboard extends Environment implements Runnable {
    ...
    public static final int OBSTACLE  = 4; // P1 Piece code in grid model
	...
	private final int P1_OBSTACLE = 16;
	private final int P2_OBSTACLE = 17;
		...
		while(true) {
			...
			switch(estado) {
				...
				case P2_JUEGA_DOS_VECES:
					...
					break;
				case P1_OBSTACLE:
					logger.info("Player1 ha movido sobre un obstaculo");	
					view.setFinPartida(P2_GANADOR);
					anotar(P2_GANADOR);
					estado = CHECK_FIN_JUEGO;
					timer.start();
					break;
				case P2_OBSTACLE:
					logger.info("Player2 ha movido sobre un obstaculo");	
					view.setFinPartida(P1_GANADOR);
					anotar(P1_GANADOR);
					estado = CHECK_FIN_JUEGO;
					timer.start();
    ...
    class BlackboardModel extends CustomModel {
        ...
        private BlackboardModel() {
            super(GSize, GSize, 2);
			data[3][3] = Blackboard.OBSTACLE;
			data[3][4] = Blackboard.OBSTACLE;
			data[4][3] = Blackboard.OBSTACLE;
			data[4][4] = Blackboard.OBSTACLE;
    ...
    class BlackboardView extends CustomView {
        ...
        public void draw(Graphics g, int x, int y, int object) {
			switch (object) {
				case Blackboard.OBSTACLE:
						drawObstacle(g, x, y);
						//logger.info("Hay un obstaculo en: ("+ x+","+y+")");
						break;
		...
		@Override
        public void drawObstacle(Graphics g0, int x, int y) {
